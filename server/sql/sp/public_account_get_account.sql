...
GO
/****** Object:  StoredProcedure [dbo].[public_account_get_account]    Script Date: 8/9/2013 7:31:59 PM ******/
SET ANSI_NULLS ON
GO
...
CREATE PROCEDURE [dbo].[public_account_get_account](
  ...
  @vc_account_password varchar(256) = NULL
)
AS
BEGIN
  ...
  BEGIN
    ...
    BEGIN
      ...
      IF (@vc_account_password IS NOT NULL)
      BEGIN
        SET @sql = @sql + ' vc_account_password = ''' + @vc_account_password + ''''
      END
    END
