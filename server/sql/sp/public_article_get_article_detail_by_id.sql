...
/****** Object:  StoredProcedure [dbo].[public_article_get_article_detail_by_id]    Script Date: 8/8/2013 7:35:41 PM ******/
SET ANSI_NULLS ON
GO
...
-- =============================================
CREATE PROCEDURE [dbo].[public_article_get_article_detail_by_id](
